          ...
          var t,
            a = function () {
              ...
              m.columns.template.setAll({
                tooltipText:
                  "دوربین فعال, تعداد {categoryY}: {male} ({malePercent.formatNumber('#.0s')}%)",
                tooltipX: am5.p100,
                cornerRadiusBR: 4,
                cornerRadiusTR: 4,
                cornerRadiusBL: 0,
              ...
              c.columns.template.setAll({
                tooltipText:
                  "دوربین فعال, تعداد {categoryY}: {female} ({femalePercent.formatNumber('#.0s')}%)",
                tooltipX: am5.p100,
                cornerRadiusBR: 4,
                cornerRadiusTR: 4,
                cornerRadiusBL: 0,
          ...
          var t,
            a = function () {
              ...
              var m = [
                ...
                { name: "اتوبان همدان سیلر", value1: 150.7, value2: 12.3 },
                { name: "کاندکس", value1: 69.4, value2: 74.5 },
                { name: "اتوبان تهرانچ", value1: 78.5, value2: 29.7 },
                ...
                { name: "ایزاتوبان۰۳", value1: 39.2, value2: 9.9 },
                { name: "اتوبان۰۳", value1: 76.6, value2: 36.9 },
                { name: "سامس", value1: 34.8, value2: 14.6 },
                { name: "اتوبان۰۳", value1: 32.1, value2: 35.6 },
                { name: "سانمکس", value1: 31.8, value2: 5.9 },
                { name: "اتوبان همدان", value1: 29.3, value2: 14.7 },
                { name: "دانور", value1: 23, value2: 2.8 },
                { name: "اتوبان همدان", value1: 21.5, value2: 12.1 },
                { name: "دانکویت", value1: 19.7, value2: 10.8 },
                { name: "اتوبان۰۳", value1: 15.5, value2: 4.1 },
            ...
            var t,
              a = function () {
                ...
                var m = [
                  ...
                  { name: "اتوبان همدان سیلر", value1: 120.7, value2: 32.3 },
                  ...
                  { name: "زندکوریشن", value1: 40.9, value2: 16.8 },
                  { name: "ایزاتوبان۰۳", value1: 39.2, value2: 9.9 },
                  { name: "اتوبان۰۳", value1: 36.6, value2: 36.9 },
                  { name: "سامس", value1: 34.8, value2: 14.6 },
                  { name: "اتوبان۰۳", value1: 32.1, value2: 35.6 },
                  { name: "سانمکس", value1: 31.8, value2: 5.9 },
                  { name: "اتوبان همدان", value1: 29.3, value2: 14.7 },
...
var KTChartsWidget33 = (function () {
  ...
  return {
    init: function () {
      var i = [
          2100, 101, 101, 2400, 2400, 1800, 1800, 2400, 2400, 101, 101, 3e3,
          3e3, 3250, 3250,
        ],
        s = [
          "10AM",
      ...
      var n = [
          2300, 2300, 2e3, 101, 101, 2800, 2400, 2400, 3100, 2900, 3100, 3100,
          2600, 2600, 101,
        ],
        d = [
          "Apr 01",
      ...
      var m = [
          2600, 101, 2300, 2300, 2e3, 101, 3100, 2900, 101, 101, 2600, 3100,
          2800, 2400, 2400,
        ],
        c = [
          "Apr 02",
      ...
      var g = [
          1800, 1800, 2400, 2400, 101, 101, 3e3, 2100, 101, 3300, 2400, 2400,
          3e3, 101, 3100,
        ],
        f = [
          "Jun 2021",
...
var KTChartsWidget34 = (function () {
    ...
    o = function (e, t, a, l, r, o) {
      ...
      if (i) {
        var s = parseInt(KTUtil.css(i, "height")),
          ...
          g = {
            series: [{ name: "میانگین سرعت", data: l }],
            chart: {
              fontFamily: "inherit",
              type: "area",
              height: s,
  ...
  return {
    init: function () {
      var i = [
          2100, 2800, 2800, 2400, 2400, 1800, 1800, 2400, 2400, 101, 101, 2800,
          2800, 3250, 3250,
        ],
        s = [
          "10AM",
      ...
      var n = [
          2300, 2300, 2e3, 3100, 3100, 2800, 2400, 2400, 3100, 2900, 101, 101,
          2600, 2600, 101,
        ],
        d = [
          "Apr 01",
      ...
      var m = [
          2600, 3400, 2300, 2300, 2e3, 3100, 3100, 2900, 101, 101, 2600, 3100,
          2800, 2400, 2400,
        ],
        c = [
          "Apr 02",
      ...
      var g = [
          1800, 1800, 2400, 2400, 3100, 3100, 3e3, 2100, 101, 101, 2400, 2400,
          3e3, 101, 3100,
        ],
        f = [
          "Jun 2021",
      ...
      var u = [
          3e3, 2100, 101, 101, 1800, 1800, 2400, 2400, 3100, 3100, 2400, 2400,
          3e3, 2400, 2800,
        ],
        p = [
          "Sep 2021",
...
var KTChartsWidget35 = (function () {
  ...
  return {
    init: function () {
      var i = [
          2100, 3100, 3100, 2400, 2400, 1800, 1800, 2400, 2400, 101, 101, 2800,
          2800, 3250, 3250,
        ],
        s = [
          "10AM",
      ...
      var n = [
          2300, 2300, 2e3, 101, 101, 2800, 2400, 2400, 3100, 2900, 101, 101,
          2600, 2600, 101,
        ],
        d = [
          "Apr 01",
      ...
      var m = [
          2600, 101, 2300, 2300, 2e3, 101, 3100, 2900, 3400, 3400, 2600, 101,
          2800, 2400, 2400,
        ],
        c = [
          "Apr 02",
      ...
      var g = [
          1800, 1800, 2400, 2400, 101, 101, 3e3, 2100, 101, 101, 2400, 2400,
          3e3, 101, 3100,
        ],
        f = [
          "Jun 2021",
      ...
      var u = [
          101, 2100, 101, 101, 101, 3500, 3e3, 2400, 3250, 2400, 2400, 3250,
          3e3, 2400, 2800,
        ],
        p = [
          "Sep 2021",
    ...
    t = function () {
      ...
      if (t) {
        var a = parseInt(KTUtil.css(t, "height")),
          ...
          o = {
            series: [
              { name: "LOI صادر شد", data: [54, 42, 75, 110, 23, 87, 50] },
            ],
            chart: {
              fontFamily: "inherit",
              type: "bar",
        ...
        var a = parseInt(KTUtil.css(t, "height")),
          ...
          s = {
            series: [
              ...
              { name: "میانگین سرعت:", data: [12, 16, 16, 21, 21, 18, 18] },
            ],
            chart: {
              fontFamily: "inherit",
              type: "area",
